        ...
        <div className={`h-24 sm:h-32 relative flex-shrink-0 ${
            ...
            <button
                ...
                className={`absolute top-2 right-2 p-1.5 rounded-full transition-all ${
                    isDarkMode ? 'bg-black/40 hover:bg-black/60 text-red-500 hover:text-red-400' : 'bg-white/60 hover:bg-white/80 text-red-500 hover:text-red-600'
                }`}
            ...
            <button
                ...
                className={`absolute top-2 right-10 p-1.5 rounded-full transition-all ${
                    isDarkMode ? 'bg-black/40 hover:bg-black/60 text-gray-400 hover:text-blue-400' : 'bg-white/60 hover:bg-white/80 text-gray-500 hover:text-blue-500'
                }`}
